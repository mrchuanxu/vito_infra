...
func Test_GetSet(t *testing.T){
	_,err :=common.EtcdClientKV.Put(context.Background(),"dbConnStr","jinmao_cn:2Nc^JeNS7Jjm0755@tcp(pc-2zet0b02gcf3ylb32-out.mysql.polardb.rds.aliyuncs.com:3306)/")
	assert.Nil(t, err)
